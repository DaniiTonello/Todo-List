...
const TaskList = ({
  ...
  return (
    <motion.div
      layout={id}
      className={`flex-shrink-0 w-[50%] z-50 max-h-full h-[inherit] overflow-y-auto overflow-x-hidden snap-center text-black bg-white border border-gray-600 p-5  rounded-md ${classname} ${
        ...
        {expanded && (
          ...
          >
            <input
              ...
              className="w-full bg-white mt-6 border border-gray-600 rounded-lg p-4"
            />
          </motion.div>
        )}
      </motion.div>
